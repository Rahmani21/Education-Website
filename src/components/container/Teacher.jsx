      ...
      <div className="grid sm:grid-cols-2 place-items-center gap-8">
        <div className="pl-5">
          ...
          <p className="text-sm leading-7 text-gray mb-5">
            An online instructor is a teacher or tutor who teaches courses over
            the internet. They provide instruction to students in their
            specified subjects based on their previous training. They mostly
